SELECT DISTINCT
    ...
    ,activereg.registry_name        "Current Registry"
...
FROM 
    ...
    LEFT OUTER JOIN PAT_ACTIVE_REG registry on pat.pat_id = registry.pat_id
    INNER JOIN REGISTRY_CONFIG activereg on registry.registry_id = activereg.registry_id
